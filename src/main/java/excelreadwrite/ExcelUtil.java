...
import static objectrepository.LaunchWebApp.testDataExcelFileName;
...
public class ExcelUtil {
	...
	public static void setExcelFileSheet(String sheetName) throws Exception {
		...
		try {
			// Open the Excel file
			testDataExcelPath = currentDir + File.separator + "src" + File.separator + "test" + File.separator + "java"
